...
namespace GameOfWar
{
    public class Deck
    {
        ...
        public int Deck(List<Card> cards, bool isEmptyDeck = false)//constructor
        {
        ...
        public void Shuffle()//finish: make a for loop and Assign i the value of a random number up to the length of card.count
        {
